...
class IrClassDeclarationTranslationVisitor(
    ...
    override fun visitFunction(declaration: IrFunction) {
        ...
        context.addDeclaration { statement(classInnerName.dot(functionName).assign(jsFunction)) }
    }
    ...
    override fun visitProperty(declaration: IrProperty) {
        ...
        if (objectLiteral.propertyInitializers.isNotEmpty()) {
            ...
            context.addDeclaration { statement(classInnerName.ref().defineProperty(propertyName.ident, objectLiteral)) }
        }
    }
}